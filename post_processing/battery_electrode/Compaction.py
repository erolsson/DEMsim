...
if __name__ == '__main__':
    simulation_directory = '../../results/viscoelastic/22hbt2-100/'

    volume_box = (0.159255*2)**2 * dimensions_box(simulation_directory)[1:9463]
    porosity = (1-(particle_volume()*(1+0.07/(0.33+0.07)))/volume_box)
    pressures = pressures_box(simulation_directory)[1:9463]
    time = Time(simulation_directory)[1:9463]
