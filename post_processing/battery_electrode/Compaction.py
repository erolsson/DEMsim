...
def pressures_box(data_directory):
    ...
    p = surface1_force/(0.21234*0.21234)

    return p


if __name__ == '__main__':
    simulation_directory = '../../results/viscoelastic/24hbt8mechanical-testing-sunday/'

    volume_box = (0.21234*2)**2 * dimensions_box(simulation_directory)[:]
