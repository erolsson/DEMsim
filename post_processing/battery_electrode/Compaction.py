...
def dimensions_box(data_directory):
    ...
    if surface_types.count('ID=') == 0 and surface_types.count('PointSurface') == 2:
        ...
        data[:, 0] = wall_data[1:79710,  id_idx[0]+32]
        print(data)
        return data
    else:
...
def pressures_box(data_directory):
    ...
    surface1_force = force_data[1:79710, surface_indices[0]+1]
...
if __name__ == '__main__':
    simulation_directory = '../../results/viscoelastic/procent65bt4E34Pelle/'
