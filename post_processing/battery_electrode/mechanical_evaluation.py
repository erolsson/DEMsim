...
def main():
    directory = os.path.expanduser(r'~/DEMsim/results/elaheh/tension-correct/unload_restart_file/')
    plot_mechanical_data_for_simulation(directory)

    directory = os.path.expanduser(r'~/DEMsim/results/elaheh/compaction-correct/relaxation/')
    plot_mechanical_data_for_simulation(directory)
