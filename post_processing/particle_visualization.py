...
if __name__ == '__main__':
    simulation_directory = '../results/viscoelastic/electrodeheightcondition085'
    ...
    animation.save_directory = '../post_processing/proctor/animation/electrodeheightcondition085/'
